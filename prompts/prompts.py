...
You are a router. Your task is to route the conversation to the next agent based on the total number of loops and feedback provided by the reviewer.
...
Here is total number of loops:
Loops: {loop}

### Criteria for Choosing the Next Agent:
- **final_report**: if Loops is greater than 2 or the Feedback marks pass_review as True. 
...
Give criteria for choosing final_report highest importance.
